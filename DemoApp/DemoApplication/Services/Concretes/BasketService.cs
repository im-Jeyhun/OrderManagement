    ...
    public class BasketService : IBasketService
    {
        ...
        public async Task<List<ProductCookieViewModel>> AddBasketProductAsync(Book book)
        {
            ...
            List<ProductCookieViewModel> AddToCookie()
            {
                ...
                book = _dataContext.Books.Include(b => b.Images).FirstOrDefault(b => b.Id == book.Id); 
                ...
                if (productCookieViewModel is null)
                {
                    productsCookieViewModel
                        ...
                        book.Images.Take(1).FirstOrDefault()! != null? _fileService.GetFileUrl(book.Images!.Take(1)!.FirstOrDefault()!.ImageNameInFileSystem!, UploadDirectory.Book) : String.Empty ,
